...
export function Application({ user, popupMsg, popup, setLoading }) {
  ...
  function getallurls() {
    fetch("https://url-shortner-backend1.herokuapp.com/users/allurls", {
      method: "GET",
      headers: {
...
function CreateShortUrl({ popupMsg, popup, setLoading, refresh }) {
  ...
  const handler = (v, e) => {
    ...
    fetch("https://url-shortner-backend1.herokuapp.com/users/creaturl", {
      method: "POST",
      headers: {
        "Access-Control-Allow-Origin": "*",
        "Content-Type": "application/json"
                ...
                <>
                  <div>
                    ...
                    <div id="short">
                      ...
                      <a
                        href={
                          "https://url-shortner-backend1.herokuapp.com/users/" +
                          v.short
                        }
                        rel="noreferrer" 
                        target="_blank"
